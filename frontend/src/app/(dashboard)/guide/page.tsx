  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Suspend or close problem accounts.',
        details: [
          'Click on a customer → "Suspend" to block credit purchases',
          'Suspended customers can still buy cash, just not credit',
          'Click "Activate" to restore credit access after they pay',
          'Click "Close Account" for permanently inactive customers',
          'Closed customers won\'t appear in the sales customer dropdown',
        ],
      },
    ],
  },
    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          ...
          'Select the receiving location (which warehouse/shop)',
          'Enter quantities actually received for each item',
          'Add optional notes about the delivery',
          'Click "Confirm Receipt" — stock is automatically added to that location',
          'Cost layers are created for FIFO tracking at the received price',
          'PO status updates to "Received" or "Partially Received"',
        ],
      },
      {
        title: 'Cancelling a PO',
        description: 'When you no longer need the order.',
        details: [
          'Click on the PO → "Cancel"',
          'Enter a reason for cancellation (required for approved POs)',
          'Draft POs can be cancelled without a reason',
          'Cancelled POs stay in history for audit trail',
        ],
      },
    ],
  },
