...
const GUIDE_SECTIONS: Section[] = [
    ...
    steps: [
      {
        ...
        details: [
          ...
          'Click Save & Confirm to deduct stock and generate the invoice',
          'Or Save as Draft to finish later — stock is not deducted until the sale is confirmed',
        ],
  ...
  // ── 4. Transfers ────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          'Open a Pending transfer → click Approve',
          'Status becomes Approved, then moves to In Transit',
          'The destination location confirms receipt by clicking Receive',
          'Stock is deducted from the source and added to the destination',
    ...
    steps: [
      {
        ...
        details: [
          ...
          'The audit status becomes In Progress',
        ],
      ...
      },
      {
        ...
        details: [
          ...
          'For each part listed, enter the physical quantity you counted',
          'The system shows the expected quantity (from the snapshot) and your count side by side',
          'Variances are highlighted automatically',
          'Save your counts as you go — you can come back and update them',
        ],
      },
      {
        ...
        details: [
          'When all counts are entered, click Submit for Approval',
          'A Manager or Admin reviews the variances and clicks Approve',
          'The system adjusts the stock quantities to match the physical count',
          'Every adjustment is written to the immutable inventory movement ledger',
          'The audit record is permanently stored for compliance and reporting',
        ],
      },
    ],
  },
    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          ...
          'All new users must change their password on first login',
          'To deactivate a user: click their name → toggle Active status off',
          'Deactivated users cannot log in but their history is preserved',
          'To reset someone\'s password: edit the user and set a new temporary password — they will be prompted to change it on next login',
        ],
        link: '/settings',
        linkLabel: 'Go to Settings',
      },
  ...
  // ── 9. Role permissions ─────────────────────────────────────────────────
  {
    ...
    icon: '🔐',
    intro: 'There are four roles. Each person should have the role that matches their job — this keeps sensitive actions protected.',
    steps: [
      {
        title: 'Admin',
      ...
      },
      {
        ...
        details: [
          ...
          'View the dashboard and their own notifications',
        ],
      },
      {
        title: 'Storekeeper',
