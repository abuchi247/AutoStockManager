...
const GUIDE_SECTIONS: { title: string; icon: string; steps: Step[] }[] = [
  {
    ...
    steps: [
      ...
      {
        title: '4. Add initial stock',
        description: 'Enter your existing inventory quantities.',
        details: [
          'Click on a part → "Adjust Stock"',
          'Select the location where the stock is',
          'Enter the quantity you have on hand',
          'This creates the initial stock and cost layers for FIFO',
        ],
      },
    ],
  },
